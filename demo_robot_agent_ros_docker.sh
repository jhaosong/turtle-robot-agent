...
for variable_name in \
    ...
    ROBOT_AGENT_DETECTION_TRACKING_MAX_CENTER_JUMP \
    ROBOT_AGENT_DETECTION_CONFIRMATION_FRAMES \
    ROBOT_AGENT_CENTER_ON_DETECTION \
    ROBOT_AGENT_IMAGE_CENTER_TOLERANCE \
    ROBOT_AGENT_CENTERING_MAX_ANGULAR_SPEED \
    ROBOT_AGENT_CENTERING_MIN_ANGULAR_SPEED \
    ROBOT_AGENT_CENTERING_GAIN \
    ROBOT_AGENT_TARGET_BOX_SIZE_NORMALIZED \
    ROBOT_AGENT_BOX_SIZE_TOLERANCE \
    ROBOT_AGENT_CENTERING_MAX_LINEAR_SPEED \
    ROBOT_AGENT_CENTERING_MIN_LINEAR_SPEED \
    ROBOT_AGENT_CENTERING_LINEAR_GAIN \
    ROBOT_AGENT_CENTERING_STABLE_FRAMES \
